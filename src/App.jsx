...
export default function App() {
  ...
  return (
    <div className="flex h-[100dvh] flex-col bg-paper dark:bg-slate-950">
      ...
      <footer className="flex shrink-0 flex-col items-center justify-center gap-1.5 border-t border-rule bg-surface/95 px-4 py-3 text-xs text-ink-faint sm:flex-row sm:gap-4 sm:px-6">
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 underline decoration-dotted underline-offset-4 hover:text-ink transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-jade cursor-pointer"
        >
